...
from csdn_spider.spider import strip_list

topic_queue_urls = Queue(maxsize=10)
...
class GetUrlThread(Thread):
    def run(self):
        ...
        print(url_list)
        for url in url_list:
            topic_queue_urls.put(url)


if __name__ == "__main__":
    get_url_thread = GetUrlThread()
